  ...
  return (
    <div className="trend" style={style}>
      <div className="trend-item">
        <span className="trend-item-label">这是第一个测试内容</span>
        <span className="trend-item-text">{wow}</span>
      </div>
      <div className="trend-item">
        <span className="trend-item-label">这是第二个测试内容</span>
  ...
  return (
    <Row gutter={[12, 12]}>
      <ColCard
        ...
        footer={<Field name="单项金额" number="￥12,423" />}
      />
      <ColCard
        loading={loading}
        metaName="总计数量"
        ...
        footer={<Field name="今日新增" number="1234" />}
      />
      <ColCard
        loading={loading}
        metaName=""
